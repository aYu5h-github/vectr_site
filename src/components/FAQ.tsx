...
const FAQ: React.FC = () => {
    return (
        <section id="faq" className="p-20 hidden md:block">
            <div className="flex flex-col lg:flex-row gap-10">
                <div className="">
                    ...
                    <a href="mailto:" className="mt-3 block text-xl lg:text-4xl text-secondary font-semibold hover:underline text-center lg:text-left">Abhinav.vectr@gmail.com</a>
                </div>
